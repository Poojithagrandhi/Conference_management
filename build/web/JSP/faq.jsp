...
<body>
  <!--/ Nav Star /-->
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top bg-image" id="mainNav"  style="background-color: #0078ff">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-10">
            ...
            <div class="title-box-2">
              <h4 class="title-comments title-left">Frequent questions</h4>
            </div>
            <ul class="list-comments">
              <li>
                ...
                <div class="comment-details">
                  <h4 class="comment-author">What is cloud computing???</h4>
                  <p>
                    Cloud computing is the use of various services, such as software development platforms, servers, storage and software, over the internet, often refered as the "cloud"...
                  </p>
                </div>
              </li>
              <li>
                ...
                <div class="comment-details">
                  <h4 class="comment-author">Who are eligible for publishing papers???</h4>
                  <p>
                    Any students can create an account and publish papers...
                  </p>
                </div>
              </li>
              <li>
                <div class="comment-avatar">
                    <img src="../img/datamining.jpg" alt="">
                </div>
                <div class="comment-details">
                  <h4 class="comment-author">What is datamining???</h4>
                  <p>
              ...
              <li>
                ...
                <div class="comment-details">
                  <h4 class="comment-author">What is networking???</h4>
                  <p>
              ...
              <li>
                ...
                <div class="comment-details">
                  <h4 class="comment-author">How much should we pay to publish a paper???</h4>
                  <p>
                        you don't have to pay anything for publishing ... If the idea gets approved you need to pay money to for attending the conference...
                  </p>
                </div>
              </li>
            </ul>
