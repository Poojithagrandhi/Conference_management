...
<%
                ...
                while(rs.next())
                {
                   ...
                   <tr>
                       ...
                       {
                       %>
                       <th style="border:2px solid black;padding: 5px"><button class="btn btn-info"><a href="assign.jsp?a=<%= request.getParameter("a") %>&b=<%= request.getParameter("b") %>&c=<%= rs.getString("rid") %>">ALLOT</a></button></th>
                       <%
                       }
                       else
                       {
