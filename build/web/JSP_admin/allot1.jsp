...
<body>
  ...
  <%
      ...
      <div class="col-md-12 ">
        <div class="card-body">
            <h3 class="card-header" style="background-color: #ff9999" ><font size="5">ALLOT REVIEWER</font></h3>
                         <div class="card-body">
...
<%
                ...
                <table style="border: 2px solid black" class="tab-content">
                    <tr>
                        ...
                        <th style="border:2px solid black;padding: 5px">ALLOT</th>
                    </tr>
                <%
                while(rs.next())
                {
                    PreparedStatement ps1=con.prepareStatement("select * from assign where rid=? and name=? and title=?");
                    ps1.setString(1, rs.getString("rid"));
                    ps1.setString(2, request.getParameter("a"));
                    ps1.setString(3, request.getParameter("b"));
                   ...
                   <tr>
                       ...
                       {
                       %>
                       <th style="border:2px solid black;padding: 5px"><button class="btn btn-info"><a href="assign1.jsp?a=<%= request.getParameter("a") %>&b=<%= request.getParameter("b") %>&c=<%= rs.getString("rid") %>">ALLOT</a></button></th>
                       <%
                       }
                       else
                       {
