...
public final class approve_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      PreparedStatement ps=con.prepareStatement("update paper set payment=1,confirm=1 where username=? and title=?");
      ps.setString(1, request.getParameter("a"));
      ps.setString(2, request.getParameter("c"));
      int x=ps.executeUpdate();
      PreparedStatement ps1 =con.prepareStatement("delete from nift where id=?");
