...
<%
                ...
                <table style="border: 2px solid black" class="tab-content">
                    <tr>
                        ...
                        <th style="border:2px solid black;padding: 5px">ALLOT-1</th>
                        <th style="border:2px solid black;padding: 5px">ALLOT-2</th>
                    </tr>
                <%
                while(rs.next())
                {
                   %>
                   <tr>
                       <th style="border:2px solid black;padding: 5px">ASCIT<%= rs.getString("id") %></th>
                       <th style="border:2px solid black;padding: 5px"><%= rs.getString("title") %></th>
                       <th style="border:2px solid black;padding: 5px"><%= rs.getString("domain") %></th>
                       <th style="border:2px solid black;padding: 5px;width: 500px"><%= rs.getString("abstract") %></th>
                       <th style="border: 2px solid black;padding: 5px"><a href="../read?msg=<%= rs.getString("id") %>"><img src="../img/docx.jpg" width="25px" height="30px"/></a></th>
                       <%
                       if(rs.getString("assign").equals("0"))
                       {
                       %>
                       <th style="border:2px solid black;padding: 5px"><button class="btn-info"><a href="allot.jsp?a=<%= rs.getString("username") %>&b=<%= rs.getString("title") %>">ALLOT</a></button></th>
                       <%
                       }
                       else
                       {
                       ...
                       if(rs.getString("assign1").equals("0"))
                       {
                       %>
                       <th style="border:2px solid black;padding: 5px"><button class="btn-info"><a href="allot1.jsp?a=<%= rs.getString("username") %>&b=<%= rs.getString("title") %>">ALLOT</a></button></th>
                       <%
                       }
                       else
                       {
