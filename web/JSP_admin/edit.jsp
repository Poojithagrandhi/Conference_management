...
<body>
  ...
  <%
      ...
      <div class="col-md-9">
        <div class="card-body">
            <h3 class="card-header" style="background-color: #ff9999" ><font size="5">EDIT RESOURCE PERSON DETAILS</font></h3>
                         <div class="card-body">
                ...
                <tr >
                    <th>Name</th>
                    <td> <input type="text" class="form-control" name="name"  required="required" value="<%= request.getParameter("b") %>"/></td></tr>
            </div>                 
                <div class="form-group">
                <tr >
                    <th>ID</th>
                    <td> <input type="text" class="form-control" name="id"  required="required" value="<%= request.getParameter("a") %>" readonly="true"/></td></tr>
            </div>
                       <div class="form-group">
                <tr >
                    <th>Domain</th>
                    <td>
                        <select name="dom" >
                            <option ><%= request.getParameter("c") %></option>
            ...
            <div class="form-group">
                <tr>
                    <th>username</th>
                    <td><input type="text" class="form-control" name="uname"  required="required" value="<%= request.getParameter("d") %>"/></td></tr>
            </div>
                ...
                <tr >
                    <th>Password</th>
                    <td> <input type="text" class="form-control" name="pwd" required="required" value="<%= request.getParameter("e") %>"/></td></tr>
            </div>
        ...
        if("post".equalsIgnoreCase(request.getMethod()))
            {
                ...
                PreparedStatement ps=con.prepareStatement("update resource set name=?,domain=?,uname=?,password=? where rid=?");
                ps.setString(1, name);
                ps.setString(2, dom);
                ...
                if(x==0){
                    ...
                    <div class="alert alert-danger">
                        <strong>FAILED TO UPDATE DETAILS </strong>
                    </div>
                    <%
                }
                else
                {
                    ...
                    <div class="alert alert-success">
                        <strong>SUCCESSFULLY UPDATED DETAILS </strong>
                    </div>
                    <%
                }      
            }
