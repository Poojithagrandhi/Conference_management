  ...
  <div class="intro intro-single route bg-image" style="background-image: url(img/overlay-bg.jpg)">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          <h2 class="intro-title mb-4">Login</h2>
                                    ...
                                    <table>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="form-label-group">
                                              ...
                                              <tr><td><input type="submit" class="btn btn-primary btn-block" value="Login"/></td>
                                                  <td><button class="btn btn-primary btn-block" style="width: 100px;"><a href="register.jsp" style="color: white">SIGN UP</a></button></td>
                                              </tr>
